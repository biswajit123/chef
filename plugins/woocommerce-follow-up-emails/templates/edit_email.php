    ...
    <form action="admin-post.php" method="post" id="sfn_form">
        ...
        <table class="form-table">
            <tbody>
                    ...
                    <td class="interval_td">
                        ...
                        <span class="hide-if-date non-signup interval_type_span hideable">
                            ...
                            <select name="interval_type" id="interval_type" class="interval_type hideable">
                                <?php
                                $triggers = SFN_FollowUpEmails::get_trigger_types($defaults['type']);
                ...
                <?php do_action('fue_edit_email_form_after_interval', $defaults); ?>
                    ...
                    <th scope="row">
                        ...
                        <span class="description">
                            ...
                            <ul>
                                ...
                                <li class="var hideable var_dollars_spent_order var_customer"><strong>{dollars_spent_order}</strong> <img class="help_tip" title="<?php _e('The total dollar amount spent on the order', 'wc_followup_emails'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
                                ...
                                <li class="var hideable var_number_orders var_customer"><strong>{number_orders}</strong> <img class="help_tip" title="<?php _e('Total number of orders made by the customer', 'wc_followup_emails'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
                                ...
                                <li class="var hideable var_final_email reminder"><strong>{final_email}...{/final_email}</strong> <img class="help_tip" title="<?php _e('The last email description...', 'wc_followup_emails'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
								<!-- Customly addded by soumya -->
        ...
        <p class="submit">
            ...
            <input type="submit" name="save" id="save" value="<?php _e('Save Follow-Up Email', 'wc_followup_emails'); ?>" class="button-primary" />
        </p>
    </form>
