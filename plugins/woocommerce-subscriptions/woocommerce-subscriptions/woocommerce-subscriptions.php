...
<?php
	 ...
	 *		'orderby' The field which the subscriptions should be orderd by. Can be '_subscription_start_date', '_subscription_expiry_date', '_subscription_end_date', '_subscription_status', 'name' or 'order_id'. Defaults to '_subscription_start_date'.
	 ...
	 * @since 1.4
	 */
	public static function get_subscription_count( $args ) {
		global $wpdb;
	...
	public static function action_links( $links ) {
		...
		$plugin_links = array(
			'<a href="' . admin_url( 'admin.php?page=woocommerce_settings&tab=subscriptions' ) . '">' . __( 'Settings', self::$text_domain ) . '</a>',
			'<a href="http://docs.woothemes.com/document/woocommerce-subscriptions/">' . __( 'Docs', self::$text_domain ) . '</a>',
			'<a href="http://support.woothemes.com">' . __( 'Support', self::$text_domain ) . '</a>',
		);
