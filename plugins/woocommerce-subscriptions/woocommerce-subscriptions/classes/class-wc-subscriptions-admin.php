...
class WC_Subscriptions_Admin {
	...
	public static function subscription_advanced_fields() {
		...
		woocommerce_wp_checkbox( array(
			...
			'label'       => __( 'Limit Subscription', WC_Subscriptions::$text_domain ),
			'cbvalue'     => 'yes',
...
<?php
	...
	public static function variable_subscription_bulk_edit_actions() {
		...
		<option value="variable_subscription_sign_up_fee"><?php _e( 'Subscription sign-up fee', WC_Subscriptions::$text_domain ); ?></option>
	...
	public static function get_settings() {
		...
		return apply_filters( 'woocommerce_subscription_settings', array(
			...
			array(
				...
				'css'      => 'min-width:150px;',
				'default'  => __( 'Sign Up Now', WC_Subscriptions::$text_domain ),
				'type'     => 'text',
				'desc_tip' => true,
			),
			...
			array(
				...
				'default'         => 'no',
				'type'            => 'checkbox',
				'desc_tip'        => sprintf( __( "With manual renewals, a customer's subscription is put on-hold until they login and pay to renew it. %sLearn more%s.", WC_Subscriptions::$text_domain ), '<a href="http://docs.woothemes.com/document/store-manager-guide/#accept-manual-renewals">', '</a>' ),
				'checkboxgroup'   => 'start',
			...
			array(
				...
				'default'         => 'no',
				'type'            => 'checkbox',
				'desc_tip'        => sprintf( __( 'If you never want a customer to be automatically charged for a subscription renewal payment, you can turn off automatic payments completely. %sLearn more%s.', WC_Subscriptions::$text_domain ), '<a href="http://docs.woothemes.com/document/store-manager-guide/#turn-off-automatic-payments">', '</a>' ),
				'checkboxgroup'   => 'end',
				'show_if_checked' => 'yes',
			),
			...
			array(
				'name'          => __( 'Failed Payment', WC_Subscriptions::$text_domain ),
				'desc'          => __( 'Add Outstanding Balance', WC_Subscriptions::$text_domain ),
				'id'            => self::$option_prefix . '_add_outstanding_balance',
				'default'       => 'no',
				'checkboxgroup'   => 'start',
				'type'          => 'checkbox',
				'desc_tip'      => __( 'If a recurring payment fails and the subscription is manually reactivated without processing the failed payment, you can choose to add the outstanding balance to the next payment.', WC_Subscriptions::$text_domain ),
			),
			...
			array(
				'desc'          => sprintf( __( 'Find new gateways that %ssupport automatic subscription payments%s in the official %sWooCommerce Marketplace%s.', WC_Subscriptions::$text_domain ), '<a href="' . esc_url( 'http://docs.woothemes.com/document/payment-gateways/' ) . '">', '</a>', '<a href="' . esc_url( 'http://www.woothemes.com/product-category/woocommerce-extensions/' ) . '">', '</a>' ),
