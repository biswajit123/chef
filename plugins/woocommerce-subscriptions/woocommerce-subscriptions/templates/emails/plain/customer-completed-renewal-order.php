...
echo sprintf( __( "Hi there. Your subscription renewal order on %s has been completed. Your order details are shown below for your reference:", WC_Subscriptions::$text_domain ), get_option( 'blogname' ) ) . "\n\n";
...
echo __( 'Your details', WC_Subscriptions::$text_domain ) . "\n\n";
