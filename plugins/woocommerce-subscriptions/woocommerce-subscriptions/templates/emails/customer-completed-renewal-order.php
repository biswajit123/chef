...
<p><?php printf( __( "Hi there. Your subscription renewal order on %s has been completed. Your order details are shown below for your reference:", WC_Subscriptions::$text_domain ), get_option( 'blogname' ) ); ?></p>
