	...
	<div class="one_half last" id="customer_login_box">
        ...
        <form method="post" class="register">
           ...
           <!--
            ...
            <p class="form-row form-row-first">
                <input type="text" class="input-text" name="zipcode" id="zipcode" value="<?php if (isset($_POST['zipcode'])) echo esc_attr($_POST['zipcode']); ?>" placeholder="<?php _e( 'Zipcode', 'Avada' ); ?>" />
            </p>
            <!-- Spam Trap -->
