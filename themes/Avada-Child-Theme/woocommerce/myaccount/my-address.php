...
<h2 class="page-info"><?php echo $page_title; ?></h2>
...
<?php foreach ( $get_addresses as $name => $title ) : ?>
	...
	<div class="one_half <?php echo ( ( $col = $col * -1 ) < 0 ) ? "" : "last"; ?> address">
		...
		<a href="<?php echo esc_url( add_query_arg('address', $name, get_permalink(woocommerce_get_page_id( 'edit_address' ) ) ) ); ?>" class="edit"><?php _e( 'Edit', 'woocommerce' ); ?> <?php echo $title; ?></a>
	</div>
