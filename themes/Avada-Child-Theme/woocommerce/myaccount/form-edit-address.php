...
<div class="woocommerce-content-box address-change">
	...
	<form action="<?php echo esc_url( add_query_arg( 'address', $load_address, get_permalink( woocommerce_get_page_id('edit_address') ) ) ); ?>" method="post">
		...
		<p>
			<input type="submit" class="button comment-submit small" name="save_address" value="<?php _e( 'Save Address', 'woocommerce' ); ?>" />
