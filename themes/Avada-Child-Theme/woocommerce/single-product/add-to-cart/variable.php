...
<form action="<?php echo esc_url( $product->add_to_cart_url() ); ?>" class="variations_form cart" method="post" enctype='multipart/form-data' data-product_id="<?php echo $post->ID; ?>" data-product_variations="<?php echo esc_attr( json_encode( $available_variations ) ) ?>">
	<table class="variations variations_in_oder_p" cellspacing="0">
		<tbody>
    ...
    <div class="single_variation single_variation_in_order"></div>
    <div class="clear"></div>
	...
	<div class="single_variation_wrap" style="display:none;">
		...
		<div class="variations_button">
			...
			<button type="submit" class="single_add_to_cart_button comment-submit small button alt"><?php echo apply_filters('single_add_to_cart_text', __( 'ORDER NOW', 'woocommerce' ), $product->product_type); ?></button>
		</div>
	</div>
