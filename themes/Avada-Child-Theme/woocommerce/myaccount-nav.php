...
<ul class="woocommerce-side-nav">
	<li class="<?php if(is_page(get_option('woocommerce_myaccount_page_id')) || is_page(get_option('woocommerce_myaccount_page_id'))) { echo 'active'; } ?>">
		<a href="<?php echo get_permalink(get_option('woocommerce_myaccount_page_id')); ?>">
			<?php _e('My Account' , 'Avada'); ?>
		</a>
	</li>
	...
	<li class="<?php if(is_page(get_option('woocommerce_view_order_page_id'))) { echo 'active'; } ?>">
        <a href="<?php echo get_permalink(get_option('woocommerce_view_order_page_id')); ?>">
            <?php _e('Past Deliverys' , 'Avada'); ?>
        </a>
    </li>
</ul>